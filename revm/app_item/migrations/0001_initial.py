    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_item.subcategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_units', models.PositiveSmallIntegerField(default=0, verbose_name='total units')),
                ('unit_type', models.CharField(max_length=10, verbose_name='unit type')),
                ('item_resources', models.ManyToManyField(related_name='item_request', to='app_item.ItemResource')),
