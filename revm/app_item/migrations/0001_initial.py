    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock', models.PositiveSmallIntegerField(blank=True, editable=False, help_text='How many units of this type are left', null=True, verbose_name='Stock')),
                ...
                ('tent_capacity', models.PositiveSmallIntegerField(default=0, verbose_name='capacity')),
                ...
                ('status', models.CharField(choices=[('NV', 'Not Verified'), ('V', 'Verified')], default='NV', max_length=5, verbose_name='status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_type', models.CharField(max_length=10, verbose_name='unit type')),
                ('expiration_date', models.DateTimeField(blank=True, null=True, verbose_name='expiration date')),
                ('stock', models.PositiveSmallIntegerField(blank=True, editable=False, help_text='How many units are still needed', null=True, verbose_name='Stock')),
                ('kids_age', models.CharField(blank=True, max_length=100, null=True, verbose_name='age')),
                ('other_textiles', models.TextField(blank=True, null=True, verbose_name='other')),
                ('tent_capacity', models.PositiveSmallIntegerField(default=0, verbose_name='capacity')),
                ('county_coverage', models.CharField(choices=[('AB', 'Alba'), ('AR', 'Arad'), ('AG', 'Argeș'), ('BC', 'Bacău'), ('BH', 'Bihor'), ('BN', 'Bistrița-Năsăud'), ('BT', 'Botoșani'), ('BV', 'Brașov'), ('BR', 'Brăila'), ('B', 'București'), ('BZ', 'Buzău'), ('CL', 'Călărași'), ('CS', 'Caraș-Severin'), ('CJ', 'Cluj'), ('CT', 'Constanța'), ('CV', 'Covasna'), ('DB', 'Dâmbovița'), ('DJ', 'Dolj'), ('GL', 'Galați'), ('GR', 'Giurgiu'), ('GJ', 'Gorj'), ('HR', 'Harghita'), ('HD', 'Hunedoara'), ('IL', 'Ialomița'), ('IS', 'Iași'), ('IF', 'Ilfov'), ('MM', 'Maramureș'), ('MH', 'Mehedinți'), ('MS', 'Mureș'), ('NT', 'Neamț'), ('OT', 'Olt'), ('PH', 'Prahova'), ('SM', 'Satu Mare'), ('SJ', 'Sălaj'), ('SB', 'Sibiu'), ('SV', 'Suceava'), ('TR', 'Teleorman'), ('TM', 'Timiș'), ('TL', 'Tulcea'), ('VS', 'Vaslui'), ('VL', 'Vâlcea'), ('VN', 'Vrancea')], max_length=2, verbose_name='county')),
