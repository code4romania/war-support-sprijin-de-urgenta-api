# Generated by Django 3.2.12 on 2022-03-01 21:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_other.subcategory')),
            ],
            options={
                'verbose_name': 'other offer',
                'verbose_name_plural': 'other offers',
            },
        ),
        migrations.CreateModel(
            name='OtherRequest',
            fields=[
                ...
                ('service_resources', models.ManyToManyField(related_name='other_request', to='app_other.OtherResource')),
                ('subcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_other.subcategory')),
            ],
            options={
